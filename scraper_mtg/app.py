...
if __name__ == '__main__':
    ...
    try:
        ...
        scraper.add_configuration('cardmarket', cardmarket)
        scraper.add_configuration('cardstore', cardstore)
        scraper.add_configuration('centrum_mtg', centrum_mtg)
        scraper.add_configuration('channelfireball', channelfireball)
        scraper.add_configuration('e_legion', e_legion)
        scraper.add_configuration('flamberg', flamberg)
        scraper.add_configuration('futurex', futurex)
        scraper.add_configuration('gamesmasters', gamesmasters)
        scraper.add_configuration('morigal', morigal)
        scraper.add_configuration('mtgstore', mtgstore)
        scraper.add_configuration('planeswalker', planeswalker)
        scraper.add_configuration('strefamtg', strefamtg)
        scraper.process()
